...
Lắp ráp metagenomic phức tạp hơn nhiều so với lắp ráp hệ gen đơn loài do:
...
\begin{itemize}
    ...
    \item \textbf{Vùng lặp lại:} Các chuỗi tương đồng giữa các loài khác nhau hoặc các vùng lặp lại trong cùng một hệ gen gây khó khăn cho việc lắp ráp chính xác
...
\begin{itemize}
    ...
    \item \textbf{Tính không hoàn chỉnh:} Hầu hết contigs chỉ đại diện cho các đoạn của hệ gen, không phải hệ gen hoàn chỉnh, do đó có thể thiếu các gen quan trọng hoặc chỉ chứa các phần của gen
...
\begin{itemize}
    ...
    \item \textbf{Prophage identification:} Phát hiện prophage được tích hợp trong hệ gen vi khuẩn
\end{itemize}
